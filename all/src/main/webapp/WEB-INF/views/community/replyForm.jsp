<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"
    isELIgnored="false"
    import="com.zerocalorie.member.dto.e_MemberDTO,com.zerocalorie.tackjun.DAO.t_MemberDAO" %>
...
<head>
<meta charset="UTF-8">
<link rel="stylesheet" href="/all/resources/board_community/css/replyForm.css">
...
<!-- 헤더 시작 -->
    <div id="j_hi">
		...
		e_MemberDTO m_dao = new e_MemberDTO();
	...
	<section>
		<div id="j_wrap">
			...
			<div id="e_box">
				 ...
				 <%
				 e_MemberDTO vo = new e_MemberDTO();
				 			vo = (e_MemberDTO)session.getAttribute("user");
				 %>
