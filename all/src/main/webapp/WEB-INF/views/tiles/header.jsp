...
<!-- 헤더 시작 -->
    <div id="j_hi">
		...
		<ul id="j_list">
            ...
            <li class="j_menu" onclick="location.href='/all/mypage/mypage'">마이페이지</li>
        </ul>
        <div id = e_nav>
        	<div id="e_welcome">
        	...
        	<!-- null 오류 방지용 시작 -->
        	<input type ='hidden' class = "j_btn" onclick="location.href='/all/member/login'" value="로그인">
            <input type ='hidden' class = "j_btn" onclick="location.href='/all/member/join'" value="회원가입">
            <!-- null 오류 방지용 끝 -->
            <!-- 나타나는 부분 시작 -->
        ...
        <div id = j_nav>
            ...
            <!-- null 오류 방지용 끝 -->
            <!-- 나타나는 부분 시작 -->
            <input type ='button' class = "j_btn" onclick="location.href='/all/member/login'" value="로그인">
            <input type ='button' class = "j_btn" onclick="location.href='/all/member/join'" value="회원가입">
            <!-- 나타나는 부분 끝 -->
        </div>
        <%
        	}
