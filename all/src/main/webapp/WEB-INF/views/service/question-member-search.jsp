				...
				<div class="e_div">
					...
					<div class="e_right">
						...
						<div class="e_paging">
							...
							%>
							<a style="margin-right:10px;" href='/all/service/question-member-search?page_NowBno=<%=s_page.getPage_StartBno()-5%>
							...
							%>
							<a href='/all/service/question-member-search?page_NowBno=<%=s_page.getPage_EndBno()+1%>
							&search_time=<%=s_searchdto.getSearch_time()%>&search_type=<%=s_searchdto.getSearch_type()%>
							&search_content=<%=URLEncoder.encode(s_searchdto.getSearch_content(), "UTF-8")%>' 
