...
public class MemberController {
	...
	public String getLogin(HttpServletRequest request)
		...
		if(session.getAttribute("user")!=null) {
			// 로그인 했을 때 - 비정상 접근
			return "redirect:/all/main/home";
		} 
		return "redirect:/all/member/login";
	}
	
	@PostMapping("/login")
	public String postLogin(@ModelAttribute MemberDTO m_dto,
		...
		if (m_service.loginMember(m_dto) == 1) {
			m_dto = m_service.load_login(m_dto);
			// 세션에 회원정보 등록
	...
	public void getLogout(HttpServletRequest request, HttpServletResponse response)
		...
		PrintWriter out = response.getWriter();
		out.println("<script language ='javascript'>alert('로그아웃 하였습니다.'); location.href='/all/main/home'; </script>");
		out.flush();
	}
	...
	@ResponseBody
	@PostMapping("/join")
	public String postJoin(@RequestBody MemberDTO m_dto,
	...
	public String postJoinComplet(@RequestBody MemberDTO m_dto,
